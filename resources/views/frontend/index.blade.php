                ...
                <div class="card ">
                    <div class="card-header">
                        <div class="bg-white shadow-sm pt-4 pl-2 pr-2 pb-2">
                            <form action="{{ route('payment.getData') }}" method="GET"
                                  enctype="multipart/form-data">
                                {{ csrf_field() }}
                                <div class="payment-div">
                                    <div class="name-div">
                                        <label>Merchant ID <span>:</span></label><br>
                                    ...
                                    <div class="input-div">
                                        <input type="text" id="merchantPgIdentifier" name="merchantPgIdentifier"><br>
                                        <input type="text" id="amount" name="amount"><br>
                                        <input type="number" id="orderId" name="orderId"><br>
                                        <input type="date" id="transactionDateTime" name="transactionDateTime"><br>
                                    </div>
