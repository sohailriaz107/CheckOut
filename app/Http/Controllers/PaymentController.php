...
class PaymentController extends Controller
{
                ...
                switch ($merchant->status) {
                    case 'active':
                        ...
                        if ($response == '00') {
                            ...
                            return redirect()->route('payment.live.return', ['response' => $response]);
                        }
                        break;
                    case 'not_active':
                        $response = '01';
    ...
    public function liveReturn($response)
    {
        ...
        if ($response == '00') {
            ...
            return redirect($successUrl . '?code=' . $response . '&secret_id=' .
                $merchant->secret_id . '&amount=' . $payment_log->amount . '&user_credits=' . $payment_log->credits . '&currency=' . $payment_log->currency .
